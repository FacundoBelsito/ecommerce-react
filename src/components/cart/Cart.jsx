...
const Cart = () => {
    ...
    return (
        <div className="mt-16 my-8  ml-16">
            {!cart.length 
            ? <div>
                <h2 className="text-2xl">Tu carrito esta vacio</h2>
                <h4 className="mt-4 my-4 ">Pasate por nuestro amplio stock de productos para poder comprar</h4>
